# Generated by Django 4.0.6 on 2022-08-11 16:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.OneToOneField(limit_choices_to={'is_school_admin': True}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Debtor',
            fields=[
                ...
                ('student_picture', cloudinary.models.CloudinaryField(max_length=255, verbose_name='student_pictures')),
                ...
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='school_admin', to='core.schooldetail')),
            ],
            options={
                'abstract': False,
            },
